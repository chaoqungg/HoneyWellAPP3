...
public abstract class ToolBarActivity extends statusActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.activity_tool_bar, menu);
            final MenuItem item = menu.findItem(R.id.action_menu);
            final MenuItem item2 = menu.findItem(R.id.action_blestate);
            ...
            View viewble=item2.getActionView();
            viewble.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        ...
        menu.findItem(R.id.action_blestate).setVisible(false);
